...
const useGradesCategories = (selectors) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getGradesCategories(selectors ? selectors.split(",") : "0");
...
const usePointsCategories = (selectors) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getPointsCategories(selectors ? selectors.split(",") : "0");
...
const useTextGradesCategories = (selectors) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getTextGradesCategories(selectors ? selectors.split(",") : "0");
        if (!data)
...
const useBehaviourGradesTypes = (selectors) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getBehaviourGradesTypes(selectors ? selectors.split(",") : "0");
        if (!data)
...
const useGradeComments = (selectors) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getGradeComments(selectors ? selectors.split(",") : "0");
...
const usePointComments = (selectors) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getPointComments(selectors ? selectors.split(",") : "0");
        if (!data) throw new Error("Failed to fetch comment data");
        setData(data);
        setError(null);
      } catch (err) {
